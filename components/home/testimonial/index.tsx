...
function SingleTestimonial(): JSX.Element {
  return (
    <div className={styles['s-testimonial-wrapper']}>
      <Block className={styles['s-testimonial']}>
        <div className={styles['s-testimonial__content']}>
          <p className={styles['s-testimonial__content__feedback']}>
            ...
            nos visitar. Creio que encontrará a igreja com uma atmosfera
            calorosa e amigável.
          </p>
          <div className={styles['s-testimonial__content__person-details']}>
            <p
              className={styles['s-testimonial__content__person-details__name']}
            >
              David Loop
            </p>
            <p
        ...
        <div className={styles['s-testimonial__picture']} />
      </Block>
    </div>
  )
}
